...
<#--    files-->
    <#list ['TimelineBlockProblem_quarter'] as solution>
<#--    numbers-->
...
<#--    fine Moves-->
    <#list ['<moveIteratorFactory>
            <fixedProbabilityWeight>${startDateWeight*fineWeight}</fixedProbabilityWeight>
    ...
    <#list ['<moveIteratorFactory>
            <fixedProbabilityWeight>${removeWeight}</fixedProbabilityWeight>
...
<#--            ${progressdelta}'] as customMoves>-->
    ...
    <solverBenchmark>
        <name>a${acceptedCountLimit?index}b${fineWeight?index}c${removeWeight?index}</name>
        <problemBenchmarks>
