...
public class FocusedAllocationSetUpdatingVariableListener implements VariableListener<Allocation> {
    ...
    public void afterVariableChanged(ScoreDirector scoreDirector, Allocation allocation) {
        ...
        if (stateSnapshot.successorAllocationBefore != null || stateSnapshot.successorAllocationAfter != null) {
            ...
            if (startAllocation == null) {
                ...
                if (stateSnapshot.successorAllocationAfter != null &&
                        stateSnapshot.successorAllocationAfter.getAllocationKey()
                                .compareTo(startAllocation.getAllocationKey()) < 0)
                    startAllocation = stateSnapshot.successorAllocationAfter;
            }
